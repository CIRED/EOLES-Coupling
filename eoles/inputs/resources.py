...
colors_eoles = {
    ...
    "Health costs": '#0173B2',
    "Stock Wood fuel-Standard boiler (Thousand households)": '#CA9161',
    "Stock Wood fuel-Performance boiler (Thousand households)": 'saddlebrown',
    "Stock Oil fuel-Standard boiler (Thousand households)": 'black',
    "Stock Oil fuel-Performance boiler (Thousand households)": '#949494',
    "Stock Natural gas-Standard boiler (Thousand households)": '#FBAFE4',
    "Stock Natural gas-Performance boiler (Thousand households)": '#CC78BC',
    "Stock Electricity-Performance boiler (Thousand households)": '#029E73',
    "Stock Electricity-Heat pump water (Thousand households)": '#0173B2',
    "Stock Electricity-Heat pump air (Thousand households)": '#DE8F05',
