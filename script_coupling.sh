...
python main_coupling_resirf.py --cpu 6 --configdir "eoles/inputs/xps/20231212" --patterns "2012*.json" "Biogas*.json" "Nuc-*.json" "Ren-*.json." "reference*.json" "Reindustri*.json" "*Flat*.json" "*Learning*.json" "Variable*.json"